...
export default function MobileNavbar({ onRegisterClick }: MobileNavbarProps) {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-ink/95 backdrop-blur-xl border-b border-cyan-500/30 px-4 py-3 flex items-center justify-between ${
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="px-3.5 py-1.5 rounded-full bg-cyan-400 text-black font-display text-[11px] font-bold uppercase tracking-wider shadow-[0_0_15px_rgba(0,229,255,0.6)]"
          >
            Register
          </a>
          ...
          <button
            ...
            className="p-2 rounded-lg bg-cyan-950/50 border border-cyan-500/40 text-cyan-400 focus:outline-none"
          >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed top-[60px] left-0 right-0 z-40 bg-ink/98 backdrop-blur-2xl border-b border-cyan-500/40 px-6 py-6 space-y-4 shadow-2xl"
          >
            ...
            <div className="pt-2">
              <a
                ...
                rel="noopener noreferrer"
                onClick={closeMenu}
                className="w-full py-3.5 rounded-xl bg-cyan-400 text-black font-display font-extrabold text-xs uppercase tracking-widest flex items-center justify-center gap-2 shadow-[0_0_25px_rgba(0,229,255,0.7)]"
              >
