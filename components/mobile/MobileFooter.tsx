...
export default function MobileFooter() {
  return (
    <footer className="bg-ink border-t border-amber-500/20 pt-12 pb-24 px-4 text-gray-400 text-xs font-sans relative z-10">
      <div className="max-w-md mx-auto space-y-8 text-center">
        {/* Brand */}
        <div className="flex flex-col items-center space-y-3">
          <div className="relative w-12 h-12 rounded-xl overflow-hidden border border-amber-400/50 bg-white/5 flex items-center justify-center">
            <Image
        ...
        {/* Quick Venue Info */}
        <div className="p-4 rounded-2xl bg-white/5 border border-amber-500/20 space-y-2 text-center">
        ...
        <div className="flex items-center justify-center space-x-4 text-gray-300">
          <a href="#" className="p-2.5 bg-white/5 border border-white/10 rounded-full text-amber-400">
