    ...
    <AnimatePresence>
      {showBar && (
        <motion.div
          ...
          className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 w-[95%] max-w-5xl glass-panel rounded-full px-4 sm:px-7 py-3 shadow-[0_10px_35px_rgba(0,0,0,0.9)] border border-amber-500/40"
        >
          <div className="flex flex-wrap items-center justify-between gap-3 text-xs sm:text-sm font-mono text-gray-200">
            {/* Left Side: Days Left Countdown + Location */}
            <div className="flex items-center gap-3 sm:gap-5 flex-wrap sm:flex-nowrap">
              {/* Animated Event Launch Countdown Timer */}
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-1 font-mono font-bold text-xs sm:text-sm">
                  <div className="bg-black/80 border border-amber-500/50 px-2 py-1 rounded-md text-amber-400 shadow-[0_0_10px_rgba(212,168,67,0.3)]">
                  ...
                  <motion.div
                    ...
                    className="bg-black/80 border border-amber-500/60 px-2 py-1 rounded-md text-white bg-gradient-to-r from-amber-950/40 to-amber-900/20 shadow-[0_0_15px_rgba(212,168,67,0.5)]"
                  >
              ...
              {/* Location Link (Now on Left Side) */}
              <a
                href={event.mapUrl}
                target="_blank"
                rel="noopener noreferrer"
                title="Open SNS IHUB Location in Google Maps"
                className="flex items-center gap-1.5 border-l border-white/15 pl-3 sm:pl-4 text-gray-200 hover:text-amber-400 transition-colors group"
              >
                ...
                <span className="group-hover:underline underline-offset-4 flex items-center gap-1 text-xs sm:text-sm">
                  ...
                  <span className="hidden md:inline-block">• {event.city}</span>
                  <ExternalLink className="w-3 h-3 text-gray-400 group-hover:text-amber-400" />
                </span>
              </a>
            </div>

            {/* Right Side: Event Date & Register Button */}
            <div className="flex items-center gap-3 sm:gap-5">
              {/* Dates */}
              <div className="hidden md:flex items-center gap-2 border-l border-white/15 pl-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-4.5 py-2 rounded-full bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-black font-display text-xs font-bold uppercase tracking-wider transition-all shadow-[0_0_20px_rgba(212,168,67,0.6)] hover:shadow-[0_0_30px_rgba(240,199,85,0.9)] hover:scale-105"
              >
